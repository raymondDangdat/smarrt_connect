...
import 'package:smarrt_connect/pages/create_account.dart';
import 'package:smarrt_connect/pages/profile.dart';
import 'package:smarrt_connect/pages/search.dart';
import 'package:smarrt_connect/pages/timeline.dart';
import 'package:smarrt_connect/pages/upload.dart';
...
class _HomeState extends State<Home> {
  ...
  createUserInFirestore() async {
    // check if user exist in users collection in database
    // according to their ID)

    final GoogleSignInAccount user = googleSignIn.currentUser;
    DocumentSnapshot doc = await usersRef.document(user.id).get();

    // if the user doesn't exists, then we want to take them to the create account page
  ...
  Scaffold buildUnAuthScreen() {
    return Scaffold(
      body: Container(
        ...
        child: Column(
          // the two lines below will center everything in the middle
